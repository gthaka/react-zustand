  ...
  return (
    <div className="navbar bg-base-100">
      <div className="navbar-start">
        <a className="btn btn-ghost normal-case text-xl">SlApp 👋🏽</a>
...
function Footer() {
  return (
    <footer className="fixed inset-x-0 bottom-0 footer items-center p-4 bg-neutral text-neutral-content">
